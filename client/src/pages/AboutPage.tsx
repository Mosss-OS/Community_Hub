        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link href="/about" className="text-sm font-medium hover:text-[#8B0000]">About</Link>
              <Link href="/sermons" className="text-sm font-medium hover:text-[#8B0000]">Sermons</Link>
              <Link href="/events" className="text-sm font-medium hover:text-[#8B0000]">Events</Link>
              <Link href="/groups" className="text-sm font-medium hover:text-[#8B0000]">Groups</Link>
              <Link href="/live" className="text-sm font-medium hover:text-[#8B0000]">Live</Link>
              <Link href="/give" className="text-sm font-medium hover:text-[#8B0000]">Give</Link>
            </div>
            <Link href="/login">
